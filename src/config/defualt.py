...
_C.DATASET.OUTPUT_SIZE = (64, 64)

# CMU DATASET SPECIFIC
_C.DATASET.NUM_VIEW = 6
_C.DATASET.NUM_FRAME_PER_SUBSEQ = 15
_C.DATASET.MAX_NUM_PEOPLE = 3
...
# TRAINING PARAMS
_C.DATASET.CMU_BATCH_SIZE = 8
_C.DATASET.CMU_NUM_WORKERS = 2
