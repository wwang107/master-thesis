...
def main(hparams):
    ...
    trainer = pl.Trainer(gpus=hparams.gpus, limit_train_batches=1, max_epochs= 20, callbacks=[LogConfusionTable(), LogModelHeatmaps(log_dir=hparams.images_dir, num_frame=cfg.DATASET.NUM_FRAME_PER_SUBSEQ)])
